...
class WeekScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final fabBottom = ShellChromeMetrics.fabStackBottomInset(context);
      ...
      body: Padding(
        ...
        child: Stack(
          ...
          children: [
                        ...
                        children: [
                          PressableScale(
                            child: IconButton(
                              ...
                              onPressed: () {
                                ref
                                    .read(weekPageAnchorProvider.notifier)
                                    .state = anchor.subtract(
            ...
            Positioned(
              right: ShellChromeMetrics.navigationBarOuterHorizontalPadding,
              bottom: fabBottom,
...
class _WeekAssistantFloat extends ConsumerWidget {
  ...
  /// Як у [AssistantBuddy]: `faceSize = size * 0.72`, обличчя по центру квадрата — зсуваємо вліво, щоб лівий край кола збігався з лівим краєм колонки (і з [ShellChromeMetrics.navigationBarOuterHorizontalPadding]).
                    ...
                    PressableScale(
                      child: FilledButton(
                        ...
                        onPressed: () {
                          ...
                          final t =
                              int.tryParse(
                                widget.targetController.text.trim(),
                              ) ??
                              1;
