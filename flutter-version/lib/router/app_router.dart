  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
        path: '/auth',
        parentNavigatorKey: _rootKey,
        pageBuilder: (context, state) => chromeFullscreenPage(
          context: context,
      ...
      GoRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final key = (d != null && d.isNotEmpty) ? d : dateKey(DateTime.now());
          return chromeFullscreenPage(
            context: context,
            pageKey: state.pageKey,
            child: CloseDayScreen(dayKey: key),
          );
        },
      ),
      GoRoute(
        ...
        pageBuilder: (context, state) {
          ...
          return chromeFullscreenPage(
            context: context,
            pageKey: state.pageKey,
            child: WeeklyReportScreen(weekKey: key),
          );
        },
      ),
