...
class _CloseDayScreenState extends ConsumerState<CloseDayScreen> {
  ...
  /// Як у Week / Routine: відступ навбара та висота асистента над системною зоною.
  static const double _shellHorizontalPad = 12;

  static double _assistantBottomFromScreen(BuildContext context) {
  ...
  Widget build(BuildContext context) {
    ...
    final isDark = brightness == Brightness.dark;
    final assistantBottom = _assistantBottomFromScreen(context);
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            textAlign: TextAlign.center,
                            style: OnboardingTypography.bodyStyle(tc, alpha: 0.72)
                                .copyWith(
                            ...
                            children: [
                              for (var i = 1; i <= 5; i++)
                                ChoiceChip(
                                  ...
                                  labelStyle: OnboardingTypography.bodyStyle(
                                    _mood == i ? _saveFg : tc,
                                    alpha: _mood == i ? 1 : (isDark ? 0.8 : 0.85),
                                  ).copyWith(
